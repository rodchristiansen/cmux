...
final class BrowserPanelTextFinderDispatchTests: XCTestCase {
    ...
    func testInPageFindScriptIncludesInputAndTextareaMatches() throws {
        ...
        XCTAssertTrue(highlightScript.contains("box-shadow: 0 0 0 1px ${payload.allBackground} !important;"))
        XCTAssertTrue(highlightScript.contains("box-shadow: 0 0 0 2px ${payload.activeBackground} !important;"))
        XCTAssertTrue(highlightScript.contains("const activeControl ="))
        XCTAssertTrue(highlightScript.contains("if (control === activeControl)"))
