---
title: Concepts
description: Understanding cmuxterm's window, workspace, pane, and surface hierarchy
---

# Concepts

cmuxterm organizes your terminals in a four-level hierarchy. Understanding these levels helps when using the socket API, CLI, and keyboard shortcuts.
