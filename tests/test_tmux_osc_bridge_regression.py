...
def main() -> int:
    ...
    expect("cmux tmux-osc-bridge --ensure --tmux-socket" in zsh, "zsh integration must auto-start tmux bridge", failures)
    ...
    expect("cmux tmux-osc-bridge --ensure --tmux-socket" in bash, "bash integration must auto-start tmux bridge", failures)
